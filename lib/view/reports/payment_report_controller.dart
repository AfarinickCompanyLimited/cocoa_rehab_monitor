...
class PaymentReportController extends GetxController {
  late BuildContext paymentReportScreenContext;

  final paymentReportFormKey = GlobalKey<FormState>();
  ...
  // ==============================================================================
  handleLoadCSV() async {
    globals.startWait(paymentReportScreenContext);
    ...
    globals.endWait(paymentReportScreenContext);
    ...
    if (postResult['status'] == true) {
      ...
      globals.showSecondaryDialog(
          context: paymentReportScreenContext,
          content: Text(
            postResult['msg'],
            style: const TextStyle(fontSize: 13),
            textAlign: TextAlign.center,
