...
class _AddInitialTreatmentMonitoringRecordState
  ...
  Widget build(BuildContext context) {
    ...
    addInitialTreatmentMonitoringRecordController = Get.put(
      AddInitialTreatmentMonitoringRecordController(),
    );
    addInitialTreatmentMonitoringRecordController
                            ...
                            children: [
                              ...
                              DropdownSearch<String>(
                                ...
                                onChanged: (val) {
                                  addInitialTreatmentMonitoringRecordController
                                      .activity = val!;
                                  // activate the sub-activity widget
                                  addInitialTreatmentMonitoringRecordController
                                      .toggleClearIsActivitySelected();

                                  Timer(
                                    const Duration(milliseconds: 1000),
                                        () => addInitialTreatmentMonitoringRecordController.toggleIsActivitySelected(),
                                  );
