...
var appIconLeaveRequest = ({Color? color, double? size}) => SvgPicture.asset(
  'assets/icon/request.svg',
  color: color,
  height: size,
  width: size,
);
var appIconGroup = ({Color? color, double? size}) => SvgPicture.asset(
  'assets/icon/group.svg',
  color: color,
  height: size,
  width: size,
);
var appIconRequestt = ({Color? color, double? size}) => SvgPicture.asset(
  'assets/icon/request.svg',
  color: color,
  height: size,
  width: size,
