...
class MaintenanceFuelCard extends StatelessWidget {
  ...
  const MaintenanceFuelCard({Key? key, required this.maintenanceFuel, this.onViewTap, this.onEditTap, this.onDeleteTap, required this.allowEdit, required this.allowDelete}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          FutureBuilder(
            ...
            future: globalController.database!.farmDao.findFarmByFarmCode(maintenanceFuel.farmdetailstblForeignkey!),
          ),
          ...
          Text("Fuel Ltr: ${maintenanceFuel.fuelLtr.toString()}",
              style: TextStyle(fontWeight: FontWeight.w600, color: AppColor.black)
          ),

          const SizedBox(height: 10),
          Text(maintenanceFuel.dateReceived ?? '',
