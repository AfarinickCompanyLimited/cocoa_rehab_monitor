...
class EditContractorCertificateRecord extends StatefulWidget {
  const EditContractorCertificateRecord({Key? key, required this.contractorCertificate, required this.isViewMode}) : super(key: key);
...
class _EditContractorCertificateRecordState
  ...
  void initState() {
    ...
    super.initState();
    editContractorCertificateRecordController.contractorCertificate = widget.contractorCertificate;
                             ...
                             children: [
                               ...
                               DropdownSearch<String>(
                                 ...
                                 items: yearList
                                     ...
                                     .toList(),
                                 selectedItem: editContractorCertificateRecordController.selectedYear.value,
                               ...
                               DropdownSearch<String>(
                                 ...
                                 selectedItem: editContractorCertificateRecordController.selectedMonth.value,
                                 autoValidateMode: AutovalidateMode.always,
                                 validator: (item) {
                                   if (item == null) {
                               ...
                               DropdownSearch<String>(
                                 ...
                                 selectedItem: editContractorCertificateRecordController.selectedWeek.value,
                                 autoValidateMode: AutovalidateMode.always,
                                 validator: (item) {
                                   if (item == null) {
                               ...
                               DropdownSearch<JobOrderFarmModel>(
                                 ...
                                 selectedItem: editContractorCertificateRecordController.jobOrderFarmModel,
                                 dropdownDecoratorProps: DropDownDecoratorProps(
                                   dropdownSearchDecoration: InputDecoration(
                                     contentPadding: const EdgeInsets.symmetric(
                                         vertical: 4, horizontal: 15),
                                 ...
                                 onChanged: (val) {
                                   ...
                                   editContractorCertificateRecordController.communityNameTC!.text = val.location.toString();
                                   // print(farmSizeTC
