...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton({Key? key, this.child, this.backgroundColor,  this.borderColor = Colors.transparent, this.isFullWidth, this.verticalPadding, @required this.horizontalPadding, this.onTap, this.borderWidth, this.width}) : super(key: key);
