...
class ItemSwitch extends StatefulWidget {
  ...
  const ItemSwitch({Key? key, @required this.items, @required this.onSelect, @required this.inActiveColor, @required this.activeColor, this.initialValue, this.backgroundColor, this.textSize = 13}) : super(key: key);
                  ...
                  child: Container(
                    ...
                    child: TextButton(
                      style: TextButton.styleFrom(
                        foregroundColor: Colors.white, backgroundColor: itemValue == selectedVal ? widget.activeColor : widget.inActiveColor,
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          itemKey,
                          style: TextStyle(color: Colors.black87, fontSize: widget.textSize),
                        ),
                      ),
                    ),
                  )
