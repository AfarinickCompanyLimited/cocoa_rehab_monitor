...
class InitialTreatmentFuelCard extends StatelessWidget {
  final InitialTreatmentFuel fuel;
  final Function? onViewTap;
  final Function? onEditTap;
  final Function? onDeleteTap;
  final bool allowEdit;
  final bool allowDelete;
  const InitialTreatmentFuelCard({Key? key, required this.fuel, this.onViewTap, this.onEditTap, this.onDeleteTap, required this.allowEdit, required this.allowDelete}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          FutureBuilder(
                  ...
                  if (dataList.isNotEmpty) {
                    return Column(
                      ...
                      children: [
                        ...
                        Text('Ref: ${dataList.first.outbreaksId ?? ''}',
            ...
            future: globalController.database!.outbreakFarmFromServerDao.findOutbreakFarmFromServerByFarmId(fuel.farmdetailstblForeignkey.toString()),
          ),
