...
RehabAssistantModel rehabAssistantFromJsonModel(String str) =>
    RehabAssistantModel.fromJson(json.decode(str));

String rehabAssistantToJsonModel(RehabAssistantModel data) => json.encode(data.toJson());
...
class RehabAssistantModel {
  ...
  factory RehabAssistantModel.fromJson(Map<String, dynamic> json) => RehabAssistantModel(
    rehabName: json["name"],
