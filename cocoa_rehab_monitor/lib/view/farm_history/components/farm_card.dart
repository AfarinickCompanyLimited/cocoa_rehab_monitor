...
class MapFarmCard extends StatelessWidget {
  final MapFarm farm;
      ...
      child: Column(
        ...
        children: [
          FutureBuilder(
            builder: (ctx, snapshot) {
              if (snapshot.connectionState == ConnectionState.done) {
                if (snapshot.hasError) {
                  ...
                  List<MapFarm> dataList = snapshot.data as List<MapFarm>;
                    ...
                    return Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              dataList.first.farmerName ?? 'first',
                              style: TextStyle(
                            ...
                            Text(
                              dataList.first.district ?? 'second',
                        ...
                        Text(
                          dataList.first.farmerContact ?? 'third',
                          style: const TextStyle(
                              fontSize: 13,
                              fontWeight: FontWeight.w600,
                              color: Colors.black),
            ...
            future: globalController.database!.mapFarmDao
                .findMapFarmByUID(farm.uid!),
          ),
          const SizedBox(height: 8),
          Text("Farm Area (Ha): ${farm.farmSize ?? ''}",
              style: TextStyle(
